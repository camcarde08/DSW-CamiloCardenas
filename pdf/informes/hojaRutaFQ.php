...
$pdf->Cell(180,4,utf8_decode('2. REACTIVOS Y ESTÁNDARES '),1,0,'L',TRUE);
            ...
            $pdf->Cell(30,4,utf8_decode('MICROORGANISMOS'),1,0,'C');
            $pdf->Cell(20,4,utf8_decode('LOTE'),1,0,'C');
            $pdf->Cell(30,4,utf8_decode('FECHA DE INGRESO'),1,0,'C');
            $pdf->Cell(30,4,utf8_decode('FECHA DE VENCIMIENTO'),1,0,'C');
            $pdf->Cell(30,4,utf8_decode('PASE DE LA CEPA'),1,0,'C');
            $pdf->Cell(40,4,utf8_decode('CONCENTRACIÓN CEPA DE TRABAJO'),1,0,'C');
            $pdf->Ln(4);
            $pdf->SetFont('Arial','B',6);
            $pdf->Cell(30,4,utf8_decode('Staphylococcus aureus'),1,0,'C');
            ...
            $pdf->Ln(4);
            $pdf->Cell(30,4,utf8_decode('Pseudomonas aeruginosa'),1,0,'C');
            $pdf->Cell(20,4,utf8_decode(' '),1,0,'C');
            $pdf->Cell(30,4,utf8_decode(' '),1,0,'C');
            $pdf->Cell(30,4,utf8_decode(' '),1,0,'C');
            $pdf->Cell(30,4,utf8_decode(' '),1,0,'C');
            $pdf->Cell(40,4,utf8_decode(' '),1,0,'C');
             $pdf->Ln(4);
            $pdf->Cell(30,4,utf8_decode('Escherichia coli'),1,0,'C');
            $pdf->Cell(20,4,utf8_decode(' '),1,0,'C');
            $pdf->Cell(30,4,utf8_decode(' '),1,0,'C');
            $pdf->Cell(30,4,utf8_decode(' '),1,0,'C');
            $pdf->Cell(30,4,utf8_decode(' '),1,0,'C');
            $pdf->Cell(40,4,utf8_decode(' '),1,0,'C');
            $pdf->Ln(4);
            $pdf->Cell(30,4,utf8_decode('Salmonella typhimurium'),1,0,'C');
            $pdf->Cell(20,4,utf8_decode(' '),1,0,'C');
            $pdf->Cell(30,4,utf8_decode(' '),1,0,'C');
            $pdf->Cell(30,4,utf8_decode(' '),1,0,'C');
            $pdf->Cell(30,4,utf8_decode(' '),1,0,'C');
            ...
            $pdf->Cell(30,4,utf8_decode('Bacillus subtilis subsp. spizizenii'),1,0,'C');
            $pdf->SetFont('Arial','B',6);
            $pdf->Cell(20,4,utf8_decode(' '),1,0,'C');
            $pdf->Cell(30,4,utf8_decode(' '),1,0,'C');
            $pdf->Cell(30,4,utf8_decode(' '),1,0,'C');
            ...
            $pdf->Cell(40,4,utf8_decode(' '),1,0,'C');
            $pdf->Ln(4);
            $pdf->Cell(30,4,utf8_decode('Clostridium sporogenes'),1,0,'C');
            $pdf->Cell(20,4,utf8_decode(' '),1,0,'C');
            $pdf->Cell(30,4,utf8_decode(' '),1,0,'C');
            $pdf->Cell(30,4,utf8_decode(' '),1,0,'C');
            $pdf->Cell(30,4,utf8_decode(' '),1,0,'C');
            $pdf->Cell(40,4,utf8_decode(' '),1,0,'C');
                                     $pdf->Ln(4);
            $pdf->Cell(30,4,utf8_decode('Candida albicans'),1,0,'C');
            $pdf->Cell(20,4,utf8_decode(' '),1,0,'C');
            $pdf->Cell(30,4,utf8_decode(' '),1,0,'C');
            $pdf->Cell(30,4,utf8_decode(' '),1,0,'C');
            $pdf->Cell(30,4,utf8_decode(' '),1,0,'C');
            $pdf->Cell(40,4,utf8_decode(' '),1,0,'C');
            $pdf->Ln(4);
            $pdf->Cell(30,4,utf8_decode('Aspergillus brasiliensis'),1,0,'C');
            $pdf->Cell(20,4,utf8_decode(' '),1,0,'C');
            $pdf->Cell(30,4,utf8_decode(' '),1,0,'C');
            $pdf->Cell(30,4,utf8_decode(' '),1,0,'C');
            $pdf->Cell(30,4,utf8_decode(' '),1,0,'C');
            ...
            $pdf->Ln(6);
            $pdf->Cell(180,4,utf8_decode('3. REACTIVOS'),1,0,'L',TRUE);
            $pdf->Ln(4);
            $pdf->SetFont('Arial','B',6);
            $pdf->Cell(30,4,utf8_decode('Medio o Caldo'),1,0,'C');
            $pdf->Cell(40,4,utf8_decode('Control Positivo'),1,0,'C');
            ...
            $pdf->Cell(30,4,utf8_decode('Observaciones'),1,0,'C');
            $pdf->Ln(4);
            $pdf->Cell(30,4,utf8_decode('TSB'),1,0,'C');
            $pdf->Cell(20,4,utf8_decode('Sa;Ec;Sal;Pse'),1,0,'C');
            $pdf->Cell(20,4,utf8_decode(' '),1,0,'C');
            $pdf->Cell(20,4,utf8_decode(''),1,0,'C');
            $pdf->Cell(20,4,utf8_decode(''),1,0,'C');
            $pdf->Cell(20,4,utf8_decode(''),1,0,'C');
            ...
            $pdf->Cell(30,4,utf8_decode(''),1,0,'C');
                        $pdf->Ln(4);
            $pdf->Cell(30,4,utf8_decode('TSA'),1,0,'C');
            $pdf->Cell(20,4,utf8_decode('Sa;Ec;Sal;Pse'),1,0,'C');
            $pdf->Cell(20,4,utf8_decode(' '),1,0,'C');
            $pdf->Cell(20,4,utf8_decode(''),1,0,'C');
            $pdf->Cell(20,4,utf8_decode(''),1,0,'C');
            ...
            $pdf->Cell(30,4,utf8_decode(''),1,0,'C');
            $pdf->Ln(4);
            $pdf->Cell(30,4,utf8_decode('SB'),1,0,'C');
            $pdf->Cell(20,4,utf8_decode('Cand; A.bra'),1,0,'C');
            $pdf->Cell(20,4,utf8_decode(' '),1,0,'C');
            $pdf->Cell(20,4,utf8_decode(''),1,0,'C');
            $pdf->Cell(20,4,utf8_decode(''),1,0,'C');
            $pdf->Cell(20,4,utf8_decode(''),1,0,'C');
            ...
            $pdf->Cell(30,4,utf8_decode(''),1,0,'C');
           $pdf->Ln(4);
            $pdf->Cell(30,4,utf8_decode('AS'),1,0,'C');
            $pdf->Cell(20,4,utf8_decode('Cand; A.bra'),1,0,'C');
            $pdf->Cell(20,4,utf8_decode(' '),1,0,'C');
            $pdf->Cell(20,4,utf8_decode(''),1,0,'C');
            $pdf->Cell(20,4,utf8_decode(''),1,0,'C');
            ...
            $pdf->Ln(5);
            $pdf->SetFont('Arial','B',9);
            $pdf->Cell(180,4,utf8_decode('4. CONCENTRACIÓN DEL PRODUCTO'),1,0,'L',TRUE);
            $pdf->Ln(4);
            $pdf->Cell(180,24,utf8_decode(''),1,0,'C');
            $pdf->Ln(26);
            $pdf->SetFont('Arial','B',9);
            $pdf->Cell(180,4,utf8_decode('5. RESULTADOS'),1,0,'L',TRUE);
           $pdf->Ln(4);
            $pdf->SetFont('Arial','B',6);
            $pdf->Cell(30,4,utf8_decode('MUESTRA'),1,0,'C');
            $pdf->Cell(40,4,utf8_decode('MICROORGANISMO'),1,0,'C');
            $pdf->Cell(30,4,utf8_decode('TIEMPO'),1,0,'C');
            $pdf->Cell(40,4,utf8_decode('RESULTADO'),1,0,'C');
            $pdf->Cell(40,4,utf8_decode('MEDIOS DE CULTIVO'),1,0,'C');
                      $pdf->Ln(4);
            $pdf->Cell(30,4,utf8_decode(' '),1,0,'C');
            $pdf->Cell(40,4,utf8_decode(' '),1,0,'C');
            $pdf->Cell(30,4,utf8_decode(' '),1,0,'C');
