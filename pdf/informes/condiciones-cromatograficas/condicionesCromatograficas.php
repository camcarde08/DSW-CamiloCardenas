...
require_once './AuxInformeCondicionesCromatograficas.php';
...
class PDF extends tFPDF {
    ...
    function init() {
        ...
        $this->aux = new AuxInformeCondicionesCromatograficas();
        $this->auxGeneral = new AuxiliarInformes();
        if ($_POST['opcion'] == 1) {
            $this->condiciones = $this->aux->obtenerCondicionesCromatograficasMuestra($idBusqueda);
        } else {
            $this->condiciones = $this->aux->obtenerCondicionCromatograficaById($idBusqueda);
        }
    }
