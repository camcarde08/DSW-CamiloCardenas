...
// Position at 1.5 cm from bottom
    ...
    function obtenerInformacionGeneral() {
        ...
        $muestraEstabilidad = EstMuestra::find($_POST['idMuestraEstabilidad']);

        $muestraEstabilidad->producto->formaFarmaceutica;

        $this->muestra = $muestraEstabilidad;
    }
    ...
    function informacionMuestra() {
        ...
        $this->Ln(-20);
        $this->SetFont('Arial', 'B', 7);
        $this->Cell(180, 50, utf8_decode('HOJA DE TRABAJO ANALíTICO ' . strtoupper($this->muestra->producto->formaFarmaceutica->descripcion) . ' ' . ($this->muestra->producto->nombre)), 0, 0, 'C');
        $this->Ln(28);
        ...
        $this->Cell(30, 7, 'LQF-' . $this->muestra->custom_id . '-' . $fechaLlegada->format('y'), 1, 0, 'C');
        $this->Cell(100, 7, utf8_decode($this->muestra->numero_lote), 1, 0, 'C');
        $this->SetFont('Arial', 'B', 9);
        $this->Ln();
        $this->Cell(180, 7, utf8_decode($this->muestra->producto->nombre), 1, 0, 'C');
        $this->Ln(10);
