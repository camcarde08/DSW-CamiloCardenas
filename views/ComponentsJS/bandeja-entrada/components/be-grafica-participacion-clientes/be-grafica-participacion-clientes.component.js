angular.module('CompBandejaEntrada')
        ...
        .controller('sgmBeParticipacionClientesCtrl', function ($filter, $http, factoryBandejaEntradaService) {
            var vm = this;
            vm.labels = [];
            vm.data = [];
            ...
            vm.onSubmit = function () {
                factoryBandejaEntradaService.getDatosGraficaParticipacionClientes($filter('date')(vm.form.fechaInicial, 'yyyy-MM-dd'), $filter('date')(vm.form.fechaFinal, 'yyyy-MM-dd'))
                        .then((response) => {
            ...
            function getDetalleParticipacionCliente(fecha_inicial, fecha_final,id_cliente){
                return $http({
                    ...
                    params: {
                        action: 'queryDb',
                        query: 'getDetalleParticipacionCliente',
        ...
        .component('sgmBeParticipacionClientes', {
            templateUrl: './views/ComponentsJS/bandeja-entrada/components/be-grafica-participacion-clientes/be-grafica-participacion-clientes.html',
            controller: 'sgmBeParticipacionClientesCtrl',
            controllerAs: 'vm',
            bindings: {
                usuario: '<',
                nombreBandeja: '<'
